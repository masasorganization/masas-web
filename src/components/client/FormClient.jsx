        ...
        <div>
            <Box sx={{ display: 'flex', 
                ...
                <Box sx={{ m: '2rem', 
                    ...
                    <Typography sx={{ mb: '0.5rem' }}>Datos personales para generar recibo:</Typography>
            ...
            <div className="btn-client">
                <Button onClick={openModal} sx={{ bgcolor: '#ff4e00', 
                                                    color: '#ffffff',
                                                    textTransform: 'none',
                                                    borderRadius: '10px',
                                                    boxShadow: '0',
            ...
            <Modal open={open}
                    ...
                    <Box sx={{ position: 'absolute',
                        ...
                        <Typography sx={{ fontWeight: '700',
                                            textAlign: 'center' }} id="title-modal">Enviar la solicitud contra-entrega</Typography>
                        <Typography sx={{ mt: '0.5rem',
                                            textAlign: 'center',
                                            mb: '2rem' }} id="description-modal">¿Verificaste muy bien todos tus datos para la entrega del producto?</Typography>
                        <Box sx={{ display: 'flex',
                                flexDirection: 'column'}}>
                            <div className="btn-client">
                                <Link to="/deliveryconf">
                                    <Button sx={{ bgcolor: '#ff4e00',
                                                    ...
                                                    ":hover": {
                                                    bgcolor: '#9bd816'
                                                    } }} >Ok, enviar solicitud</Button>
                                </Link>
                                <Button onClick={closeModal} sx={{ bgcolor: '#c30500',
                                                                    color: '#ffffff',
                                                                    borderRadius: '10px',
                                                                    boxShadow: '0',
                                                                    mt: '1rem',
